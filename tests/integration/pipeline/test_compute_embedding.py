...
class TestComputeEmbeddingStep:
    ...
    @pytest.mark.asyncio
    async def test_compute_embedding_success(self, compute_embedding_step, sample_generated_posts, mock_embedding_service):
    ...
    @pytest.mark.asyncio
    async def test_compute_embedding_empty_input(self, compute_embedding_step, mock_embedding_service):
    ...
    @pytest.mark.asyncio
    async def test_compute_embedding_handles_errors(self, compute_embedding_step, sample_generated_posts, mock_embedding_service):
    ...
    @pytest.mark.asyncio
    async def test_compute_embedding_all_fail(self, compute_embedding_step, sample_generated_posts, mock_embedding_service):
        """Test when all embedding generations fail."""
        compute_embedding_step._embedding_service = mock_embedding_service
        mock_embedding_service.generate_embedding = AsyncMock(side_effect=Exception("Service down"))
